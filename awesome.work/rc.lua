...
awful.util.spawn("pkill -9 xscreensaver")
awful.util.spawn("pkill -9 conky")
awful.util.spawn("pkill -9 qsynergy")
awful.util.spawn("pkill -9 synergy")
awful.util.spawn("xrandr --output DVI-1 --rotate right")
awful.util.spawn("conky -c /home/samuel/dotfiles/.conkyrc.work.new &")
awful.util.spawn("hime &")
...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        gears.wallpaper.maximized(wallpaper[s.index], s, true)
    end
end
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "壹", "貳", "參", "肆", "伍", "陸" }, s, awful.layout.layouts[1])
