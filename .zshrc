...
if [[ "$unamestr" == 'Linux' ]]; then
    ...
    platform='Linux'
    plugins=(git vi-mode tmux docker docker-compose zsh-navigation-tools vagrant)
    ...
    platform='Darwin'
    plugins=(git vi-mode tmux docker docker-compose zsh-navigation-tools osx vagrant)
fi
